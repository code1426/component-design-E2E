...
export const BasicTask: React.FC<BaseTaskProps> = ({
  task,
  onToggleComplete,
  onRemove,
  onEdit,
  ...
  <Card
    className={`transition-all hover:shadow-md border-l-4 border-purple-500 relative ${
  ...
  >
    <CardHeader className="flex justify-between p-3 border-b">
      <div className="flex items-center space-x-2">
        <Badge
          variant="outline"
          className="bg-purple-50 text-purple-600 border-gray-200"
        >
          Task # {task.id}
        </Badge>
        <Badge
